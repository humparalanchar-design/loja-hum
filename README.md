[index.html.txt](https://github.com/user-attachments/files/21765785/index.html.txt)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    ...
    <script>
        ...
        const sampleProducts = {
            '1': {
                ...
                details: 'Ingredientes: Chocolate belga, ovos caipira, farinha especial, açúcar cristal, manteiga francesa. Rico em cacau 70%. Serve 8 pessoas. Peso aproximado: 1,2kg.',
                stock: 0,
                minStock: 0,
                image: '',
                emoji: '🍰'
            ...
            '2': {
                ...
                details: 'Massa vermelha aveludada com cobertura de cream cheese. Decoração especial. Serve 10 pessoas.',
                stock: 3,
                minStock: 5,
                image: '',
                emoji: '🎂'
            ...
            '3': {
                ...
                details: 'Massa de baunilha com cobertura cremosa de buttercream. Decoração colorida.',
                stock: 24,
                minStock: 10,
                image: '',
                emoji: '🧁'
            ...
            '5': {
                ...
                details: 'Ganache de chocolate meio amargo com cobertura de cacau em pó. Sabor intenso e cremoso.',
                stock: 40,
                minStock: 8,
                image: '',
                emoji: '🍫'
            ...
            '10': {
                ...
                details: 'Suco 100% natural de laranjas selecionadas, sem adição de açúcar ou conservantes. Rico em vitamina C. Copo de 300ml.',
                stock: 15,
                minStock: 3,
                image: '',
                emoji: '🥤'
            ...
            '11': {
                ...
                details: 'Café expresso feito com grãos selecionados, moído na hora. Servido em xícara de 50ml.',
                stock: 30,
                minStock: 10,
                image: '',
                emoji: '☕'
            ...
            '12': {
                ...
                category: 'bebidas',
                type: 'ambos',
                description: 'Vitamina cremosa com frutas da estação',
                details: 'Vitamina feita com frutas frescas da estação, leite e mel. Rica em vitaminas. Copo de 400ml.',
                stock: 8,
                minStock: 5,
                image: '',
                emoji: '🥤'
        ...
        const cepDatabase = {
            '01000000': { city: 'São Paulo', neighborhood: 'Sé', distance: 5 },
            '04038001': { city: 'São Paulo', neighborhood: 'Vila Olímpia', distance: 8 },
                ...
                fetch(`https://viacep.com.br/ws/${cep}/json/`)
                    ...
                    .then(data => {
                        if (!data.erro) {
                            ...
                            deliveryFeeSpan.textContent = deliveryFee > 0 ? `R$ ${deliveryFee.toFixed(2)}` : 'Grátis';
                            updateCartTotal();
                        } else {
        ...
        function updateCartTotal() {
            ...
            const deliveryFee = deliveryFeeText === 'Grátis' ? 0 : parseFloat(deliveryFeeText.replace('R$ ', ''));
            ...
            content.innerHTML = `
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600 leading-relaxed">${product.details || 'Informações detalhadas não disponíveis.'}</p>
                    </div>
                    
                    ${product.type === 'encomenda' || product.type === 'ambos' ? 
                        `<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                            <h4 class="text-blue-800 font-semibold mb-2">
                                <i class="fas fa-info-circle mr-2"></i>Informações sobre Encomenda
                            </h4>
                            <p class="text-blue-700 text-sm">
                                Este produto pode ser feito sob encomenda. Pedidos devem ser feitos com pelo menos 3 dias de antecedência.
                    ...
                    <div class="flex space-x-4">
                        <button onclick="addToCart('${product.id}')" 
                            ...
                            <i class="fas fa-cart-plus mr-2"></i>
                            ${(product.type !== 'encomenda' && product.stock === 0) ? 'Indisponível' : 'Adicionar ao Carrinho'}
                        </button>
        ...
        function updateSavedDataIndicator() {
            ...
            if (customerData.name) {
                ...
                loadBtn.title = `Dados salvos disponíveis: ${customerData.name}`;
            } else {
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                            <div class="text-sm text-green-800 space-y-1">
                                ...
                                ${asaasPaymentData ? `<p><strong>🆔 ID Pagamento:</strong> ${asaasPaymentData.id}</p>` : ''}
                                <p><strong>⏰ Válido até:</strong> ${new Date(Date.now() + 30 * 60 * 1000).toLocaleString('pt-BR')}</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                            <p class="text-sm text-yellow-800">
                                ...
                                ${asaasPaymentData ? 
                                    ...
                                    'Após realizar o PIX, clique em "Confirmar Pagamento" para finalizar seu pedido.'
                                }
                            </p>
                        </div>
                ...
                content = `
                    <div>
                        <h4 class="text-lg font-semibold mb-4 text-blue-600 text-center">
                            <i class="fas fa-credit-card mr-2"></i>Pagamento com Cartão de Crédito
                        </h4>
                        ...
                        <form id="credit-card-form" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="card-installments" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="1">1x de R$ ${order.total.toFixed(2)} (à vista)</option>
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-orange-50 p-4 rounded-lg mb-4">
                            <div class="text-sm text-orange-800 space-y-2">
                                ...
                                <p><strong>📅 Antecipado (50%):</strong> R$ ${advancePayment.toFixed(2)}</p>
                                <p><strong>🚚 Na Entrega (50%):</strong> R$ ${remainingPayment.toFixed(2)}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <button onclick="showAdvancePayment('${order.id}', 'credit_card', ${advancePayment})" 
                                    ...
                                    <i class="fas fa-credit-card mr-2"></i>Cartão de Crédito - R$ ${advancePayment.toFixed(2)}
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <p class="text-sm text-yellow-800">
                                <i class="fas fa-info-circle mr-2"></i>
                                Após o pagamento antecipado, entraremos em contato para confirmar os detalhes da encomenda.
                                Os 50% restantes serão pagos na entrega.
                            </p>
                        </div>
                    </div>
                `;
        ...
        function sendWhatsAppNotifications(order, paymentType) {
            ...
            const storeMessage = `🎉 *NOVO PEDIDO CONFIRMADO!*
...
💳 *Pagamento:* ${paymentType === 'pix' ? 'PIX' : paymentType === 'credit_card' ? 'Cartão de Crédito' : 'Encomenda'}
✅ *Status:* CONFIRMADO
...
${order.delivery.date ? `📅 Data: ${order.delivery.date} ${order.delivery.time || ''}` : ''}

${order.orderData && (order.orderData.eventType || order.orderData.observations) ? `
🎯 *Dados da Encomenda:*
${order.orderData.eventType ? `• Evento: ${order.orderData.eventType}` : ''}
${order.orderData.observations ? `• Observações: ${order.orderData.observations}` : ''}
` : ''}

⏰ *Pedido feito em:* ${new Date(order.createdAt).toLocaleString('pt-BR')}`;

            // Message for the customer
            const customerMessage = `🎉 *Pedido Confirmado - ${settings.confeitariaName}*

Olá ${order.customer.name}! Seu pedido foi confirmado com sucesso! 
...
🎯 *Encomenda:*
• Prazo mínimo: 3 dias úteis
• Entraremos em contato para confirmar detalhes
${order.paymentMethod === 'encomenda' ? '• Restante do pagamento na entrega' : ''}
` : `
⚡ *Pronta Entrega:*
...
Obrigado pela preferência! 💜`;
        ...
        function showAdvancePayment(orderId, paymentType, amount) {
            ...
            if (paymentType === 'pix') {
                    ...
                    <div class="text-center">
                        ...
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                            <p class="text-sm text-yellow-800">
                                ...
                                Após realizar o PIX, clique em "Confirmar Pagamento" para finalizar.
                            </p>
                        </div>
                ...
                const content = `
                    <div>
                        <h4 class="text-lg font-semibold mb-4 text-blue-600 text-center">
                            <i class="fas fa-credit-card mr-2"></i>Pagamento Antecipado - Cartão
                        </h4>
                        ...
                        <form id="advance-credit-card-form" class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nome no Cartão</label>
                                <input type="text" id="advance-card-name" placeholder="NOME COMO NO CARTÃO" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                       style="text-transform: uppercase;">
                            </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <p class="text-xs text-blue-700">
                                    Pagamento antecipado de 50%. Os outros 50% serão pagos na entrega.
                                </p>
                            </div>
        ...
        function sendAdvanceWhatsAppNotifications(order, paymentType) {
            ...
            // Message for the store
            const storeMessage = `🎉 *ENCOMENDA CONFIRMADA - PAGAMENTO ANTECIPADO!*
...
💰 *Valores:*
• Total: R$ ${order.total.toFixed(2)}
• *Antecipado (50%): R$ ${advanceAmount.toFixed(2)}* ✅
• Restante na entrega: R$ ${remainingAmount.toFixed(2)}

💳 *Pagamento Antecipado:* ${paymentType === 'pix' ? 'PIX' : 'Cartão de Crédito'}
✅ *Status:* CONFIRMADO
...
CEP: ${order.delivery.cep}
${order.delivery.reference ? `📍 ${order.delivery.reference}` : ''}
📅 Data: ${order.delivery.date} ${order.delivery.time || ''}
...
⚠️ *AÇÃO NECESSÁRIA:*
• Entrar em contato com cliente para confirmar detalhes
• Prazo mínimo: 3 dias úteis
• Restante do pagamento na entrega

⏰ *Pedido feito em:* ${new Date(order.createdAt).toLocaleString('pt-BR')}`;

            // Message for the customer
            const customerMessage = `🎉 *Encomenda Confirmada - ${settings.confeitariaName}*

Olá ${order.customer.name}! Seu pagamento antecipado foi confirmado! 

📋 *Pedido:* #${order.id}
💰 *Total:* R$ ${order.total.toFixed(2)}
✅ *Antecipado (50%):* R$ ${advanceAmount.toFixed(2)}
🚚 *Restante na entrega:* R$ ${remainingAmount.toFixed(2)}
💳 *Pagamento:* ${paymentType === 'pix' ? 'PIX' : 'Cartão de Crédito'}
...
🎯 *Próximos Passos:*
• Entraremos em contato para confirmar todos os detalhes
• Prazo mínimo: 3 dias úteis para produção
• O restante (R$ ${remainingAmount.toFixed(2)}) será pago na entrega
• Você receberá atualizações sobre o andamento

${order.orderData.eventType ? `🎉 *Evento:* ${order.orderData.eventType}` : ''}
${order.orderData.observations ? `📝 *Suas observações:* ${order.orderData.observations}` : ''}
...
Obrigado pela confiança! 💜`;
                ...
                <div class="text-center">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                        <div class="text-sm text-green-800 space-y-2">
                            <p><strong>💰 Valor Pago:</strong> R$ ${order.total.toFixed(2)}</p>
                            <p><strong>💳 Método:</strong> ${paymentType === 'pix' ? 'PIX' : 'Cartão de Crédito'}</p>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                        <p class="text-sm text-blue-800">
                            ...
                            • Seu pedido foi confirmado e está sendo preparado<br>
                            • Você receberá atualizações por WhatsApp<br>
                    ...
                    <div class="space-y-2">
                        ...
                        <button onclick="window.open('https://wa.me/${settings.phone.replace(/\D/g, '')}?text=Olá! Acabei de fazer o pedido ${orderId}', '_blank')" 
        ...
        function showAdvancePaymentSuccess(orderId, paymentType) {
            ...
            const content = `
                <div class="text-center">
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                        <div class="text-sm text-green-800 space-y-2">
                            <p><strong>💰 Valor Antecipado:</strong> R$ ${advanceAmount.toFixed(2)}</p>
                            <p><strong>🚚 Restante na Entrega:</strong> R$ ${remainingAmount.toFixed(2)}</p>
                            <p><strong>💳 Método:</strong> ${paymentType === 'pix' ? 'PIX' : 'Cartão de Crédito'}</p>
                            <p><strong>📅 Data:</strong> ${new Date().toLocaleDateString('pt-BR')}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
                        <p class="text-sm text-orange-800">
                            <i class="fas fa-info-circle mr-2"></i>
                            <strong>Próximos Passos:</strong><br>
                            • Entraremos em contato para confirmar detalhes da encomenda<br>
                            • Você receberá atualizações sobre o andamento<br>
                            • Os 50% restantes serão pagos na entrega<br>
                            • Prazo mínimo: 3 dias úteis
                        </p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <button onclick="window.open('https://wa.me/${settings.phone.replace(/\D/g, '')}?text=Olá! Acabei de fazer o pagamento antecipado do pedido ${orderId}', '_blank')" 
                                class="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg transition-colors">
                            <i class="fab fa-whatsapp mr-2"></i>Falar no WhatsApp
                        </button>
                    </div>
        ...
        function saveCustomerData() {
            ...
            if (currentData.name.trim() && currentData.phone.trim()) {
                ...
                saveData();
                showNotification('Dados salvos para próximas compras!', 'success');
            }
        }
        ...
        function clearSavedCustomerData() {
            showConfirmationModal(
                'Tem certeza que deseja apagar todos os dados salvos do cliente? Esta ação não pode ser desfeita.',
                () => {
                    customerData = {};
                    saveData();
        ...
        function handleLogoUpload(input) {
            ...
            if (file.size > 2 * 1024 * 1024) {
                showNotification('O logo deve ter no máximo 2MB!', 'error');
                input.value = '';
                return;
            }
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">
                                Aprovação instantânea • Desconto de ${settings.pixDiscountPercent}%
                                ${settings.pixFee > 0 ? ` • Taxa: R$ ${settings.pixFee.toFixed(2)}` : ''}
                            </p>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                ${settings.creditCardFeePercent > 0 ? ` • Taxa: ${settings.creditCardFeePercent}%` : ''}
                            </p>
                        </div>
                        <div class="text-right">
                            <span class="text-sm text-blue-600">Até ${settings.maxInstallments}x</span>
            ...
            if (settings.enableDebitCard) {
                ...
                debitMethod.innerHTML = `
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            <span class="font-medium text-gray-800">Cartão de Débito</span>
                            <p class="text-sm text-gray-600">
                                Débito à vista
                                ${settings.debitCardFeePercent > 0 ? ` • Taxa: ${settings.debitCardFeePercent}%` : ''}
                            </p>
                        </div>
                        <div class="text-right">
                            <span class="text-sm text-purple-600">À vista</span>
            ...
            if (settings.enableBoleto) {
                ...
                boletoMethod.innerHTML = `
                    <div class="flex items-center">
                        ...
                        <div class="flex-1">
                            <span class="font-medium text-gray-800">Boleto Bancário</span>
                            <p class="text-sm text-gray-600">
                                Vencimento em 3 dias úteis
                                ${settings.boletoFee > 0 ? ` • Taxa: R$ ${settings.boletoFee.toFixed(2)}` : ''}
                            </p>
                        </div>
                        <div class="text-right">
            ...
            if (settings.enableEncomenda) {
                ...
                encomendaMethod.innerHTML = `
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-orange-600">Flexível</span>
                    </div>
                `;
            ...
            if (container.children.length === 0) {
                container.innerHTML = `
                    <div class="text-center py-4 text-gray-500">
                        ...
                        <p class="text-sm">Configure os métodos no painel administrativo.</p>
                    </div>
                `;
            }
        }
        ...
        function processAsaasPayment(order) {
            if (!settings.asaasApiKey) {
                showNotification('Integração com Asaas não configurada!', 'error');
                ...
                infoText = `
                    <div class="bg-yellow-50 border border-yellow-200 rounded p-2">
                        <p class="text-yellow-800 text-xs">
                            ...
                            <br>Taxa: ${settings.monthlyInterestRate}% ao mês
                        </p>
                    </div>
                `;
            } else {
                    ...
                    infoText = `
                        <div class="bg-green-50 border border-green-200 rounded p-2">
                            <p class="text-green-800 text-xs">
                                ...
                                <strong>À vista:</strong> R$ ${total.toFixed(2)}
                            </p>
                        </div>
                    `;
                } else {
            ...
            Object.values(categories).forEach(category => {
                ...
                categoryCard.innerHTML = `
                    ...
                    <div class="flex space-x-2">
                        ...
                        <button onclick="deleteCategory('${category.id}')" class="flex-1 ${productsInCategory > 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-500 hover:bg-red-600'} text-white py-2 px-3 rounded text-sm transition-colors" ${productsInCategory > 0 ? 'disabled title="Não é possível excluir categoria com produtos"' : ''}>
        ...
        function deleteCategory(categoryId) {
            ...
            if (productsInCategory > 0) {
                showNotification(`Não é possível excluir a categoria "${category.name}" pois ela possui ${productsInCategory} produto(s)!`, 'error');
                return;
            }
        ...
        function updateCategoryPreview() {
            ...
            const description = document.getElementById('categoryDescription').value || 'Descrição da categoria';
        ...
        function renderAdminProducts() {
            ...
            Object.values(products).forEach(product => {
                ...
                productCard.innerHTML = `
                    ...
                    <p class="text-gray-600 text-sm mb-3">${product.description || 'Sem descrição'}</p>
                    <div class="flex justify-between items-center mb-3">
                ...
                orderCard.innerHTML = `
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-600">✉️ ${order.customer.email}</p>
                            ${order.customer.cpf ? `<p class="text-sm text-gray-600">🆔 CPF: ${order.customer.cpf}</p>` : ''}
                        </div>
                        <div class="text-right">
                            ...
                            <p class="text-sm text-gray-600 mt-1">💳 ${order.paymentMethod || 'N/A'}</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        ${order.delivery.reference ? `<p class="text-sm text-gray-600">📍 ${order.delivery.reference}</p>` : ''}
                        ${order.delivery.date ? `<p class="text-sm text-gray-600">📅 ${order.delivery.date} ${order.delivery.time || ''}</p>` : ''}
                    </div>
                    ...
                    ${order.orderData && (order.orderData.eventType || order.orderData.observations) ? `
                        <div class="mb-3">
                            ...
                            ${order.orderData.observations ? `<p class="text-sm text-gray-600"><strong>Observações:</strong> ${order.orderData.observations}</p>` : ''}
                        </div>
                    ` : ''}
        ...
        function deleteOrder(orderId) {
            const order = orders[orderId];
            showConfirmationModal(
                `Tem certeza que deseja excluir o pedido #${orderId} do cliente ${order.customer.name}? Esta ação não pode ser desfeita.`,
                () => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-3 text-center">
                        <span class="text-lg font-semibold ${product.type === 'encomenda' ? 'text-blue-600' : product.stock === 0 ? 'text-red-600' : product.stock <= product.minStock ? 'text-yellow-600' : 'text-green-600'}">
                            ${product.type === 'encomenda' ? '∞' : product.stock}
                        </span>
                    </td>
                    <td class="px-4 py-3 text-center">
        ...
        function quickStockAdjustment(productId, action) {
            ...
            if (product.type === 'encomenda') {
                showNotification('Produtos por encomenda não têm controle de estoque!', 'info');
                return;
            }
            ...
            stockMovements.push({
                ...
                oldStock: oldStock,
                newStock: product.stock,
                reason: `Ajuste manual - ${action === 'add' ? 'Entrada' : 'Saída'}`,
                date: new Date().toISOString().split('T')[0],
                time: new Date().toLocaleTimeString()
            });
            ...
            container.innerHTML = `
                <div class="bg-white p-4 rounded-lg border">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <p><strong>👤 Nome:</strong> ${customerData.name || 'N/A'}</p>
                            <p><strong>📱 Telefone:</strong> ${customerData.phone || 'N/A'}</p>
                            <p><strong>✉️ Email:</strong> ${customerData.email || 'N/A'}</p>
                            <p><strong>🆔 CPF:</strong> ${customerData.cpf || 'N/A'}</p>
                        </div>
                        <div>
                            <p><strong>📍 CEP:</strong> ${customerData.cep || 'N/A'}</p>
                            <p><strong>🏙️ Cidade:</strong> ${customerData.city || 'N/A'}</p>
                            <p><strong>🏠 Endereço:</strong> ${customerData.address || 'N/A'}, ${customerData.number || 'N/A'}</p>
                            <p><strong>🏘️ Bairro:</strong> ${customerData.neighborhood || 'N/A'}</p>
        ...
        document.getElementById('customer-form').addEventListener('submit', function(e) {
            ...
            if (currentEditingCustomer) {
                ...
                if (existingCustomer) {
                    showNotification('Já existe um cliente com este email!', 'error');
                    return;
                }
        ...
        document.getElementById('settings-form').addEventListener('submit', function(e) {
            ...
            if (newUsername && newUsername !== settings.adminUsername) {
                ...
                showNotification('Usuário administrador atualizado!', 'success');
            }
                ...
                <body>
                    ...
                    <div class="order-info">
                        ...
                        <div class="info-section">
                            ...
                            <p><strong>Endereço:</strong> ${order.delivery.address}, ${order.delivery.number}</p>
                            ...
                            ${order.delivery.reference ? `<p><strong>Referência:</strong> ${order.delivery.reference}</p>` : ''}
                    ...
                    ${order.orderData && (order.orderData.eventType || order.orderData.observations) ? `
                        <div class="info-section" style="margin-bottom: 20px;">
                            ...
                            ${order.orderData.observations ? `<p><strong>Observações:</strong> ${order.orderData.observations}</p>` : ''}
                        </div>
                    ` : ''}

                    <div class="items-section">
                        <h3 style="margin-bottom: 10px; color: #8B5CF6;">🛍️ ITENS DO PEDIDO</h3>
                    ...
                    <div class="info-section" style="margin-top: 20px;">
                        ...
                        <p><strong>Método:</strong> ${paymentTexts[order.paymentMethod] || order.paymentMethod}</p>
                        <p><strong>Status:</strong> ${order.paymentConfirmed ? '✅ Confirmado' : '⏳ Aguardando'}</p>
                        ...
                        ${order.paymentMethod === 'encomenda' ? `
                            <div style="margin-top: 10px; padding: 10px; background-color: #FEF3C7; border-radius: 5px;">
                                <p><strong>💰 Pagamento Encomenda:</strong></p>
                                <p>• Antecipado (50%): R$ ${(order.total * 0.5).toFixed(2)} ${order.advancePaymentConfirmed ? '✅' : '⏳'}</p>
                                <p>• Na Entrega (50%): R$ ${(order.total * 0.5).toFixed(2)}</p>
                                ${order.advancePaymentMethod ? `<p>• Método Antecipado: ${order.advancePaymentMethod === 'pix' ? 'PIX' : 'Cartão de Crédito'}</p>` : ''}
                            </div>
                        ` : ''}
                        
                        ${order.paymentDetails ? `
                            <div style="margin-top: 10px;">
                                <p><strong>Cartão:</strong> **** **** **** ${order.paymentDetails.lastFourDigits}</p>
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">✉️ ${customer.email}</p>
                                ${customer.cpf ? `<p class="text-sm text-gray-600">🆔 ${customer.cpf}</p>` : ''}
                            </div>
                        </div>
                        <div class="text-right">
                            ...
                            <p class="text-sm text-gray-600 mt-1">💰 R$ ${totalSpent.toFixed(2)}</p>
                        </div>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 mb-2">📍 Endereço:</h4>
                            <p class="text-sm text-gray-600">
                                ${customer.address ? `${customer.address}, ${customer.number || 'S/N'}` : 'Não informado'}
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Último pedido: ${lastOrderDate}</p>
                            ${customer.birthDate ? `<p class="text-sm text-gray-600">🎂 Nascimento: ${new Date(customer.birthDate).toLocaleDateString('pt-BR')}</p>` : ''}
                            <p class="text-sm text-gray-600">📅 Cadastro: ${new Date(customer.createdAt).toLocaleDateString('pt-BR')}</p>
                        </div>
                    </div>
        ...
        function deleteCustomer(customerId) {
            ...
            if (customerOrders.length > 0) {
                message += `\n\nEste cliente possui ${customerOrders.length} pedido(s) no histórico.`;
            }
        ...
        function viewCustomerOrders(customerId) {
            ...
            if (customerOrders.length === 0) {
                showNotification('Este cliente ainda não fez nenhum pedido.', 'info');
                return;
            }
        ...
        function exportCustomers() {
            ...
            // Create CSV content
            const headers = ['Nome', 'Telefone', 'Email', 'CPF', 'Data Nascimento', 'CEP', 'Cidade', 'Endereço', 'Número', 'Complemento', 'Bairro', 'Observações', 'Data Cadastro'];
            const csvContent = [
                headers.join(','),
        ...
        function printCustomer(customerId) {
                ...
                <body>
                    ...
                    <div class="customer-info">
                        <div class="info-section">
                            ...
                            ${customer.updatedAt ? `<p><strong>Última Atualização:</strong> ${new Date(customer.updatedAt).toLocaleDateString('pt-BR')}</p>` : ''}
                        </div>

                        <div class="info-section">
                            <h3>📍 ENDEREÇO</h3>
                            ${customer.address ? `
                                <p><strong>Endereço:</strong> ${customer.address}, ${customer.number || 'S/N'}</p>
                                ${customer.complement ? `<p><strong>Complemento:</strong> ${customer.complement}</p>` : ''}
                                <p><strong>Bairro:</strong> ${customer.neighborhood || 'Não informado'}</p>
                    ...
                    <div class="stats-section">
                        <h3 style="text-align: center; margin-bottom: 15px; color: #8B5CF6;">📊 ESTATÍSTICAS DO CLIENTE</h3>
                    ...
                    ${customerOrders.length > 0 ? `
                        <div class="orders-section">
                            <h3 style="margin-bottom: 10px; color: #8B5CF6;">🛍️ HISTÓRICO DE PEDIDOS</h3>
                            ...
                            <div style="margin-top: 15px;">
                                <h4 style="color: #8B5CF6; margin-bottom: 10px;">📦 Produtos Mais Pedidos:</h4>
                                ${(() => {
                                    const productCount = {};
                                    ...
                                    return sortedProducts.length > 0 ? 
                                        sortedProducts.map(([product, count]) => 
                                            `<p style="margin-bottom: 3px;">• ${product}: ${count} unidade${count !== 1 ? 's' : ''}</p>`
                                        ).join('') : 
                    ...
                    ` : `
                        <div class="info-section">
                            <h3 style="color: #8B5CF6;">🛍️ HISTÓRICO DE PEDIDOS</h3>
                    ...
                    <div class="footer">
                        ...
                        <p>Sistema de Gestão - ${settings.confeitariaName}</p>
                    </div>
            ...
            showNotification(`Ficha do cliente ${customer.name} aberta para impressão!`, 'success');
        }
        ...
        function printCustomers() {
            ...
            showNotification('Relatório de clientes aberto para impressão!', 'success');
        }
        ...
        function printStock() {
            ...
            const printContent = `
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0">
                    <title>Relatório de Estoque - ${settings.confeitariaName}</title>
                    <style>
                        * {
                            margin: 0;
                            padding: 0;
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; font-size: 10px;">
                            <div>
                                ...
                                <span class="type-badge type-pronta">Pronta</span> - Disponível imediatamente<br>
                            ...
                            <div>
                                ...
                                <span class="status-badge status-low">Estoque Baixo</span> - Abaixo do mínimo<br>
                                <span class="status-badge status-out">Sem Estoque</span> - Esgotado<br>
                                <span class="status-badge status-encomenda">Sob Encomenda</span> - Não controla estoque
                            </div>
                        </div>
                    </div>
            ...
            showNotification('Relatório de estoque aberto para impressão!', 'success');
        }
        ...
        function generateFakeOrder() {
            ...
            const fakeAddresses = [
                ...
                },
                {
                    ...
                    reference: 'Em frente ao shopping Vila Olímpia'
                },
                {
                    cep: '05407-002',
                    city: 'São Paulo',
                    ...
                    reference: 'Próximo ao metrô Faria Lima'
                },
                {
                    cep: '01452-000',
                    city: 'São Paulo',
                    ...
                    reference: 'Próximo ao Parque Trianon'
                },
                {
                    cep: '04094-050',
                    city: 'São Paulo',
                    ...
                    reference: 'Próximo ao Shopping Morumbi'
                }
            ];
            ...
            const fakeOrder = {
                ...
                orderData: {
                    ...
                    observations: orderType === 'encomenda' ? [
                        'Bolo com tema de unicórnio, cores rosa e roxo',
                        'Decoração simples e elegante',
                        'Sem açúcar, diabético na família',
...
<script type="module">
  // Importa direto do Firebase CDN
  import { initializeApp } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-app.js";
  import { getAnalytics } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-analytics.js";
